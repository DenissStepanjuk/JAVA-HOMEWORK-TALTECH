 ...
 * @author Deniss
 */
public class CommercialSoftware extends Software  {

    
    public CommercialSoftware(String title, String developer, String dateInstall, String timeLimit,String price){
        this.title = title;
    ...
    public String toString() {
        return "CommercialSoftware{" + "title=" + title + ", developer=" + developer + ", dateInstall=" + dateInstall + ", timeLimit=" + timeLimit + ", price=" + price +'}';
    }        
